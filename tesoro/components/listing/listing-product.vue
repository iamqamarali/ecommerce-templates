<template>
    <a href="/single-product" class=" product d-block" :class="{ 'listing-product': listingProduct }">
        <div class="card product-card">
            ...
            <div class="product-imgs-wrapper">
                ...
                <no-ssr>
                    <a href="#" class="heart-icon">
                        <i class="fi fi-8x flaticon-like"></i>
                    </a>
                </no-ssr>
            ...
            <div class="card-body product-card-body">
                ...
                <div class="rating-review-container" v-if="product.review_count">
                ...
                <br class="rating-review-placeholder" v-if="!product.review_count">

    ...
    <div class="product-preview-wrapper" :class="{'in-modal': inModal} ">
        <div class="product-preview">
            ...
            <div class="row no-gutters">
                <div class="product-images-column d-none d-lg-flex" :class="{ 'col-lg-8' : !inModal , 'col-lg-6' :inModal }">
                    <div class="product-images-container">
                        <a href="" class="like-btn" v-if="!inModal">
                            <i class="fi flaticon-like fs-8x"></i>
                        </a> 

                        <product-images-view :images="selectedColor.images"></product-images-view>
                    </div>
                </div> 
                <div class="product-detail-column " :class="{ 'col-lg-4' : !inModal , 'col-lg-6' :inModal }">               
...
-->
                        ...
                        <!-- this is for mobile -->
                        <div class="product-images-container d-lg-none">
                            <a href="" class="like-btn" v-if="!inModal">
                                <i class="fi flaticon-like fs-8x"></i>
                            </a> 
...
-->
                        ...
                        <button class="btn product-add-to-bag-btn"
                            ...
                            Add To Bag
                            <i class="fi flaticon-shopping-bag ml-2 fs-6x"></i>
                        </button>
